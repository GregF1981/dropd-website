...
export const metadata: Metadata = {
  title: "Terms of Service — dropd",
  description: "dropd Terms of Service — the rules governing your use of the platform.",
};

const sections = [
  { id: "about",             n: "1",  title: "About dropd" },
        ...
        <article className="py-14">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sm:p-10">
              ...
              <P>
                By creating an account, accessing, or using dropd, you confirm that you have read, understood, and agree to be bound by these Terms of Service and our{" "}
                <Link href="/privacy" className="underline" style={{ color: "#0095f6" }}>Privacy Policy</Link>.
                {" "}If you do not agree, do not use dropd.
              </P>

              <H2 id="eligibility" n="3">Eligibility</H2>
              <ul className="list-disc pl-5 space-y-1.5 mt-2">
                <Li>You must be at least <strong>18 years of age</strong> to use dropd.</Li>
                ...
                <Li>By using dropd you represent and warrant that you meet all eligibility requirements.</Li>
              </ul>

              <H2 id="age-verification" n="4">Age Verification</H2>
              <Sub n="4.1 Minimum age:">You must be at least 18 years of age to create an account or use any part of the dropd platform. By registering, you confirm that you are 18 or older.</Sub>
              <Sub n="4.2 Verification on request:">dropd may require you to verify your age at any time. This may include providing a government-issued photo ID or completing a third-party age verification process. Failure to provide satisfactory verification may result in suspension or termination of your account.</Sub>
              <Sub n="4.3 No access by minors:">You must not allow any person under the age of 18 to access dropd through your account or device. If you become aware that a minor has accessed the platform using your account, you must notify us immediately via Help &amp; Support in the dropd app.</Sub>
              ...
              <Sub n="7.2 Notify us of compromise:">If you believe your account has been compromised, accessed without authorisation, or your password has been lost or stolen, you must notify us immediately via Help &amp; Support in the dropd app. We will take reasonable steps to help secure your account.</Sub>
              ...
              <Sub n="7.4 Your responsibility:">You are responsible for all activity that occurs under your account, including purchases, messages, and content posted. dropd is not liable for any loss or damage arising from your failure to keep your credentials secure.</Sub>

              <H2 id="tokens" n="8">Token System</H2>
              <Sub n="8.1 What tokens are:">Tokens are a virtual currency used within the dropd platform. Tokens have no cash value outside of dropd and cannot be exchanged for cash by fans.</Sub>
              ...
              <Sub n="9.4 What constitutes a reply:">Any response sent by the host through the dropd platform within the 72-hour window constitutes a reply.</Sub>
              ...
              <Sub n="10.2 Setting your price:">Hosts may set their own token price per message within limits set by dropd.</Sub>
              ...
              <Sub n="10.5 Platform fee:">dropd deducts a platform fee of 20% from all host token earnings. The remaining 80% is credited to the host&apos;s account.</Sub>
              ...
              <Sub n="10.8 Tax obligations:">Hosts are solely responsible for reporting and paying all applicable taxes on their earnings. dropd does not provide tax advice.</Sub>
              <Sub n="10.9 Verification:">Hosts may apply for official verification. Verification is at dropd&apos;s sole discretion.</Sub>
              ...
              <Sub n="12.1 Your content:">You retain ownership of content you post on dropd.</Sub>
              ...
              <Sub n="13.1 Licence grant:">By posting, uploading, or otherwise making content available on dropd, you grant dropd a non-exclusive, irrevocable, royalty-free, worldwide licence to use, reproduce, display, distribute, adapt, and communicate that content for the purposes of operating, promoting, and improving the platform.</Sub>
              <Sub n="13.2 Scope:">This licence covers all formats and media now known or later developed, and includes the right to sub-licence to third-party service providers engaged by dropd to operate the platform.</Sub>
              ...
              <Sub n="14.1 Right to request removal:">Any person who is depicted in content posted on dropd without their consent may submit a removal request via Help &amp; Support in the dropd app. Requests must include sufficient detail to identify the content in question and the basis for the request.</Sub>
              ...
              <Sub n="15.1 How to report:">Users may report content or conduct that they believe breaches these terms using our in-app reporting tools or via Help &amp; Support in the dropd app.</Sub>
              ...
              <Sub n="16.1 Voluntary feedback:">We welcome feedback, ideas, and suggestions about dropd. You are not obliged to provide any feedback, and we are not obliged to act on any feedback you provide.</Sub>
              <Sub n="16.2 Ownership of feedback:">Any feedback, ideas, suggestions, or improvements you submit to dropd — whether in writing, verbally, or through any other means — become the sole and exclusive intellectual property of dropd. By submitting feedback you assign to dropd all rights, title, and interest in that feedback, including any intellectual property rights, with no obligation of confidentiality, attribution, or compensation to you.</Sub>
              <Sub n="16.3 No restriction:">dropd may use, incorporate, or commercialise any feedback in any way it sees fit, without restriction.</Sub>
              ...
              <Sub n="18.1 Our IP:">The dropd platform, including its design, code, trademarks, and content created by us, is owned by dropd and protected by Australian and international intellectual property laws.</Sub>
              <Sub n="18.2 Limited licence:">We grant you a limited, non-exclusive, non-transferable licence to use the dropd platform for personal, non-commercial purposes.</Sub>
              ...
              <P>
                Your use of dropd is subject to our{" "}
                <Link href="/privacy" className="underline" style={{ color: "#0095f6" }}>Privacy Policy</Link>,
              ...
              <Sub n="20.1">The dropd platform is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any kind, express or implied.</Sub>
              ...
              <Sub n="21.1">To the maximum extent permitted by law, dropd&apos;s total liability to you for any claim arising out of or in connection with these terms or your use of the platform shall not exceed the total amount of tokens you have purchased in the 12 months preceding the claim.</Sub>
              ...
              <Sub n="27.2">Your continued use of dropd after changes take effect constitutes acceptance of the updated terms.</Sub>
              <Sub n="27.3">If you do not agree to the updated terms, you must stop using dropd and delete your account.</Sub>
              ...
              <Sub n="28.3">Upon termination, your right to use dropd ceases immediately. Content may be retained as required by law.</Sub>

              <H2 id="general" n="29">General</H2>
              <Sub n="29.1 Entire agreement:">These terms constitute the entire agreement between you and dropd regarding your use of the platform.</Sub>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mt-3 text-sm text-gray-600">
                <div className="font-semibold text-gray-900 mb-1">dropd Legal</div>
